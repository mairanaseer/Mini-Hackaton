...
export default function car3(){
    return(
        ...
        <div className="flex justify-center items-center my-20 ">
            <h1 className="text-3xl underline font-bold">HONDA CITY 2024 Price in Pakistan,images,reviews and speces</h1></div>
            <div className="flex justify-center my-20">
                <img src ="/OIF.jpeg" className="h-80 w-70"/>
            </div>
            ...
            <div className="flex justify-center py-4">
                <div className="text-green-700 font-2xl">PKR 46.5 58.5 LAC</div>
            </div>
