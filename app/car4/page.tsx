...
export default function car4(){
    return(
        ...
        <div className="flex justify-center items-center my-20 ">
            <h1 className="text-3xl underline font-bold">HONDA CIVIC 2024 Price in Pakistan,images,reviews and speces</h1></div>
            <div className="flex justify-center my-20">
                <img src ="/Cover.jpg" className="h-80 w-70"/>
            </div>
            ...
            <div className="flex justify-center py-4">
                <div className="text-green-700 font-2xl">PKR 86.6 99.0 LAC</div>
            </div>
