...
export default function car1(){
    return(
        ...
        <div className="flex justify-center items-center my-20 ">
            <h1 className="text-3xl underline font-bold">Toyota Corolla 2024 Price in Pakistan,images,reviews and speces</h1></div>
            <div className="flex justify-center my-20">
                <Image src ="/Corolla-X-Cars-Cropped-Pictures-for-Website.jpg" className="h-80 w-70"
                height={80}
                width={70}
                alt="car"/>
            </div>
            ...
            <div className="flex justify-center py-4">
                <div className="text-green-700 font-2xl">PKR 50,00,000</div>
            </div>
